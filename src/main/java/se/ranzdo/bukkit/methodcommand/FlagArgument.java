...
public class FlagArgument extends CommandArgument {
    ...
    public FlagArgument(String name, String description, String def, String verifiers, Class<?> argumentClass,
    ...
    public Object execute(CommandSender sender, Arguments args) throws CommandError {
        ...
        if (!args.flagExists(flag)) {
            ...
            throw new CommandError(
                    "The argument s [" + getName() + "] to the flag -"
                            + flag.getIdentifier() + " is " + "not defined"
            );
        } else {
