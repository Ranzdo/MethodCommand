...
import se.ranzdo.bukkit.methodcommand.annotations.*;
        ...
        for (int i = 1; i < methodParameters.length; i++) {
            ...
            if (commandArgAnnotation == null) {
                if (argumentClass != boolean.class && argumentClass != Boolean.class)
                    throw new RegisterCommandMethodException(method, "The flag annotation is present on a parameter without the arg annotation, however the parameter type is not an boolean.");
