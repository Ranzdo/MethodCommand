...
public @interface Arg {
     ...
     * The verifiers differs from what class the parameter have. To check which verifiers are available, see the {@linkplain se.ranzdo.bukkit.methodcommand.arguments.handle.ArgumentHandler} for that class.
     */
