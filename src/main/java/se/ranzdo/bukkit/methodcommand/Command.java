...
public @interface Command {
     ...
     * sub commands as you want, as long as the first command (the root) is defined in the plugin.yml file.<br><br>
     ...
     * writing (if the root command does not choose an alias instead):<br>
     ...
     * permission.<br><br>
     * If the user don't have one of the permissions, they will get an error message stating that they do not have
